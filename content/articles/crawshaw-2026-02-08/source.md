...
I wrote up my experiences programming with LLMs [a bit over a year ago](https://crawshaw.io/blog/programming-with-llms), and updated it for the world of agents [eight months ago](https://crawshaw.io/blog/programming-with-agents). A lot has changed since then, so here is an update.
